...
public class PaymentPage extends BasePage<PaymentPage> {
    ...
    public SelenideElement placeSuccessMessage = $x("//p[text()='Congratulations! Your order has been confirmed!']");
    public SelenideElement downloadInvoiceButton = $x("//a[text()='Download Invoice']");
    public SelenideElement continueButton = $x("//a[text()='Continue']");
    ...
    public PaymentPage clickDownloadInvoiceButton () {
        elementManager.click(downloadInvoiceButton);
        return this;
    }
